...
public class StellarRestorationReusableData : SkillReusableData
{
    ...
    public StellarRestorationReusableData(SkillStateMachine skill) : base(skill)
    {
        ...
        objectPool = new ObjectPool<HairpinTeleporter>("Prefabs/Characters/PlayableCharacters/Keqing/HairpinTeleporter", playableCharacterStateMachine.characters.transform);
